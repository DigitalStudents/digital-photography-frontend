      ...
      <section className="content">
        <div className="imgfooter">
          <div className="logofooter">
            <img src="/src/components/Footer/svg/logo.jpeg" alt="Logo" />
          </div>
          <h1 className="contacto">contacto@filmbook.com</h1>

          <div className="iconosfooter">
            <a href="https://www.facebook.com"><img src="/src/components/Footer/svg/icon-facebook.svg" alt="Facebook" /></a>
            <a href="https://www.twitter.com"><img src="/src/components/Footer/svg/icon-twitter.svg" alt="Twitter" /></a>
            <a href="https://www.instagram.com"><img src="/src/components/Footer/svg/icon-instagram.svg" alt="Instagram" /></a>
          </div>
        </div>
