...
function Home() {
  ...
  return (
    ...
    <Navbar expand="lg" className="bg-color sticky-top">
      ...
      <Hero heroImage={'/src/assets/images/camera-hero-banner.webp'} tilte={"RENTA TU CÁMARA IDEAL"} subtitle={"Lleva tus producciones a otro nivel con nuestra gran variedad de productos"} />
