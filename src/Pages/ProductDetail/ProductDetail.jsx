...
export default function ProductDetail(){
    ...
    return (
        <div style={styles.container}>
            <img src={producto.imagen} style={styles.image} alt={producto.nombre} />
            <h1 style={styles.title}>Título: {producto.nombre}</h1>
            <h2 style={styles.subtitle}>Tipo: {producto.tipo}</h2>
            <h2 style={styles.subtitle}>Descripción: {producto.descripcion}</h2>
            <h3 style={styles.price}>Precio: ${producto.precio_por_dia}</h3>
        </div>
    );
}